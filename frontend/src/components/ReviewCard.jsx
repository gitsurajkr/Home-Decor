    ...
    return (
        <div className="pb-7">
            ...
            <div className="relative flex flex-col items-center justify-center py-10 px-4 bg-silver max-w-[80vw] mx-auto">
                ...
                <button
                    onClick={handleNext}
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center justify-center  rounded-full w-10 h-10 hover:shadow-lg hover-bg-white transition-all"
